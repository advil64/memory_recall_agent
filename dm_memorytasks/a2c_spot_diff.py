...
tmp_path = "/common/home/ac1771/Desktop/memory_recall_agent/dm_memorytasks/sb3_log_2/"
# set up logger
...
class PsychLab(gym.Env):
    def __init__(self, env_config):
        ...
        env_settings = dm_memorytasks.EnvironmentSettings(seed=123, level_name='spot_diff_train')
...
model.learn(total_timesteps=1000000, log_interval=4, callback=FigureRecorderCallback())
model.save("a2c_spot_diff")